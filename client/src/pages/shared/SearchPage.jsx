...
export default function SearchPage() {
    ...
    const fetchResults = useCallback(async () => {
        ...
        if (!q && !searchParams.get('department') && !searchParams.get('year') && type === 'all') {
    ...
    const handleFilterChange = (name, value) => {
        ...
        if (nextFilters.type !== 'all') newParams.type = nextFilters.type;
        if (nextFilters.department) newParams.department = nextFilters.department;
        if (nextFilters.year) newParams.year = nextFilters.year;
    ...
    return (
        <div className="space-y-6 fade-in">
            ...
            {loading ? (
                <PageSpinner />
            ) : !searchParams.get('q') && !searchParams.get('department') && !searchParams.get('year') && (searchParams.get('type') || 'all') === 'all' ? (
                <EmptyState
